...
## [0.25.0](https://github.com/scbjans/opentelemetry-ruby-contrib/compare/opentelemetry-instrumentation-rack-v0.24.0...opentelemetry-instrumentation-rack/v0.25.0) (2024-01-19)
...
* Remove retain_middleware_names Rack Option ([#356](https://github.com/scbjans/opentelemetry-ruby-contrib/issues/356))
* Remove parent repo libraries ([#3](https://github.com/scbjans/opentelemetry-ruby-contrib/issues/3))

### Features

* Add experimental traceresponse propagator to Rack instrumentation ([#182](https://github.com/scbjans/opentelemetry-ruby-contrib/issues/182)) ([4e2d98b](https://github.com/scbjans/opentelemetry-ruby-contrib/commit/4e2d98bd635e099518fc05041057e94e967186d5))
...
* Remove retain_middleware_names Rack Option ([#356](https://github.com/scbjans/opentelemetry-ruby-contrib/issues/356)) ([d84a8cb](https://github.com/scbjans/opentelemetry-ruby-contrib/commit/d84a8cb949c5f846174c8136a2b98e06bf265b75))
* Use Rack Events By Default ([f7f4603](https://github.com/scbjans/opentelemetry-ruby-contrib/commit/f7f46037bdda286a25763a31ae5236c947f060ed))
* Use Rack::Events for instrumentation ([#342](https://github.com/scbjans/opentelemetry-ruby-contrib/issues/342)) ([c179d3b](https://github.com/scbjans/opentelemetry-ruby-contrib/commit/c179d3b0f8c69c03867b84c667f98abb66f46a41))


### Bug Fixes

* Backport Rack proxy event to middleware ([#764](https://github.com/scbjans/opentelemetry-ruby-contrib/issues/764)) ([3d0f818](https://github.com/scbjans/opentelemetry-ruby-contrib/commit/3d0f818c06a2b246425c114b41bec260b9274bc0))
...
* bring http.request.header and http.response.header in line with … ([#111](https://github.com/scbjans/opentelemetry-ruby-contrib/issues/111)) ([1af9fc1](https://github.com/scbjans/opentelemetry-ruby-contrib/commit/1af9fc1a35264dcaf3bd0d88234e8ad8dacdaa22))
* bring http.request.header and http.response.header in line with semantic conventions. ([1af9fc1](https://github.com/scbjans/opentelemetry-ruby-contrib/commit/1af9fc1a35264dcaf3bd0d88234e8ad8dacdaa22))
...
* Ensure Rack Events Handler Exists ([#519](https://github.com/scbjans/opentelemetry-ruby-contrib/issues/519)) ([823883b](https://github.com/scbjans/opentelemetry-ruby-contrib/commit/823883bab58d90c4b92937b25c5acf582bf81fa3))
